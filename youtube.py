...
def Api_connect():
    Api_Id="AIzaSyB6vPJ7zGwZkg_qmbqcMwAuKL2nLHsqUPM"
...
#upload to mongoDb
client=pymongo.MongoClient("mongodb+srv://rishi:Rishi9361453241@rishiraj.tclky0q.mongodb.net/?retryWrites=true&w=majority&appName=Rishiraj")
...
#table creation for channels, playlists,comments, videos
...
if question=="1. All the videos and the channel name":
    ...
    mydb.commit()
    t4=cursor.fetchall()
    df4=pd.DataFrame(t4,columns=["no_of_comments","video_title"])
    st.write(df4)
    ...
    mydb.commit()
    t5=cursor.fetchall()
    df5=pd.DataFrame(t5,columns=["video_title","channel_name","like_count"])
    st.write(df5)


elif question=="6. Total Likes of all videos":
    query6='''select likes as likecount,title as videotitle from videos '''
    cursor.execute(query6)
    mydb.commit()
    t6=cursor.fetchall()
    df6=pd.DataFrame(t6,columns=["like_count","video_title"])
    st.write(df6)


elif question=="7. TotalViews of each channel":
